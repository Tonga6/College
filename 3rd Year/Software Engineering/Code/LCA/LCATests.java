...
public class LCATest {
    ...
    public void testNoLCA(){     
        ...
        graph.getAllParents(graph, allParentsA, graph.nodes.get(2), 0);
        graph.getAllParents(graph, allParentsB, graph.nodes.get(5), 0);
    ...
    public void testSingleLCA(){     
        ...
        graph.getAllParents(graph, allParentsA, graph.nodes.get(1), 0);
        graph.getAllParents(graph, allParentsB, graph.nodes.get(2), 0);
        ...
        ArrayList<ArrayList<Node>> ansA = new ArrayList<ArrayList<Node>>();
        ArrayList<Node> ansAEntry = new ArrayList<Node>();
        ansAEntry.add(graph.nodes.get(0));
        ansA.add(ansAEntry);
        assertEquals(arrLCA, ansA);
    }
